...
import com.shubhamgupta.nebula_music.NebulaMusicApplication
...
object EqualizerManager {
    ...
    private fun saveSettings() {
        ...
        val context = NebulaMusicApplication.getAppContext()
    ...
    fun loadSettings() {
        val context = NebulaMusicApplication.getAppContext() ?: return
